...
const calculator = (number1, number2) => (
 ...
 // Referência usada para retornar o valor de um número arredondado para o seu número inteiro, ou seja, para baixo, descartando os decimais: https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/Math/trunc;
